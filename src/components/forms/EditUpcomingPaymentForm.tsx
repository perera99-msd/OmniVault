...
export function EditUpcomingPaymentForm({ payment, wallets }: EditUpcomingPaymentFormProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger render={
        <Button variant="outline" size="sm" className="h-8 rounded-xl font-bold bg-[#ffffff] dark:bg-[#424242] border-[#d7ccc8] dark:border-[#616161]">
          Edit
        </Button>
      } />
      <SheetContent className="bg-white dark:bg-[#161917] border-l border-zinc-200 dark:border-white/5 sm:max-w-md w-full">
        <SheetHeader className="mb-6">
          <SheetTitle className="text-2xl font-extrabold text-zinc-900 dark:text-white">Edit Payment</SheetTitle>
