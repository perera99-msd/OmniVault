...
export function ThemeSettings() {
  ...
  return (
    <div className="bg-white dark:bg-[#161917] p-6 rounded-[2rem] border border-zinc-200 dark:border-white/5 shadow-xl flex flex-col gap-6 relative overflow-hidden group">
      ...
      <div>
        <h3 className="text-lg font-extrabold tracking-tight text-zinc-900 dark:text-white mb-1">Appearance</h3>
